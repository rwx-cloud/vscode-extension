...
echo "  • Test YAML aliases:"
echo "    - Go-to-definition: Ctrl+Click or F12 on *alias → jumps to &anchor"
echo "    - Hover: Hover over *alias → shows anchor content"
echo "    - Find references: Shift+F12 on &anchor → shows all *aliases"
echo "  • Test task dependencies:"
echo "    - Go-to-definition: Ctrl+Click on task name in use: → jumps to task definition"
echo "    - Find references: Shift+F12 on task key → shows all use: references"
